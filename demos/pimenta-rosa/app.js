...
if ('IntersectionObserver' in window) {
  const targets = document.querySelectorAll('.hero-content > *, .hero-foot, .highlights > *, .intro > div > *, .intro figure, .section-head > div > *, .section-head > p, .cards article, .photo-grid figure, .destination > *, .contact-card > *, .cta > *, footer > *, .disclosure');
